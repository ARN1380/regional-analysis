  ...
  return (
    <div className="bg-[#1e1e24] p-5 rounded-xl border border-zinc-800 flex flex-col h-full">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto max-h-52 space-y-2 pr-2 rtl:pr-0 rtl:pl-2 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-zinc-700 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-zinc-500 transition-colors"
      >
  ...
  return (
    <div className="mt-6 space-y-4">
      <div className="bg-[#1e1e24] p-4 rounded-xl border border-zinc-800 flex items-center gap-5">
        <button
          onClick={togglePlay}
          className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white shrink-0 hover:bg-blue-500 hover:scale-105 transition-all shadow-lg shadow-blue-900/20 cursor-pointer"
        >
      ...
      <div className="bg-[#1e1e24] p-4 rounded-xl border border-zinc-800 flex justify-between items-center">
        ...
        <button
          ...
          className={`bg-blue-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium flex items-center gap-2 transition-all ${
...
export default function RegionalDashboard() {
  const [appLanguage, setAppLanguage] = useState("fa"); // DEFAULT SET TO PERSIAN
